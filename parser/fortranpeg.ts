...
export type Inicio = [_, Identificador, _, "=", _, Expresiones, _];
export type Expresiones = [TipoComilla, _, Literales, _, TipoComilla];
export type TipoComilla = "'" | '"';
export type Identificador = string;
export type Literales = string;
