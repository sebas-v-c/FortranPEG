...
// @ts-ignore
  ...
  var peg$e36 = peg$otherExpectation("nueva linea");
...
export type Inicio = [Instruccion[], __];
export type Instruccion =
  ...
  | Comentarios;
export type Eleccion = [Concatenacion, [__, "/", __, Concatenacion][]];
export type Concatenacion = [Pluck, [_, Pluck][]];
